...
import {  getBalance , setBalance } from '../../actions/admin/balance';
...
export default connect(mapStateToProps, {  getBalance , setBalance })(AdminBalance);