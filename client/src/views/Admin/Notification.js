...
const Notification = ({ getNotifications, deleteNotification, notification: { notifications }, auth }) => {
        ...
        <div  className='relative m-auto text-left'>    
            {notifications.map((_notification, index) => (
                <div id="toast-simple" class="flex items-center p-4 mb-4 text-xl text-white bg-[rgba(13,9,255,0.6)]  rounded-lg " role="alert" key={ index}>
                        ...
                        <div class="pl-4  font-normal text-green font-mono text-xl">Request from {_notification.account} to {_notification.method} {_notification.amount}.</div>
