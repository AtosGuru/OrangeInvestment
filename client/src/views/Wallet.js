...
const Wallet = ({getWallets , deleteWallet , wallet: { wallets } , auth }) => { 
    ...
    return (
        <div className='relative container m-auto '> 
            <Link to={'/createWallet'} className="rounded-bl-3xl rounded-tr-3xl mt-5 inline-flex justify-center items-center gap-5 text-white text-xl  bg-transparent border border-white  w-full hover:border-black hover:text-2xl  rounded-lg  px-6 py-3.5 text-center">
                <b>Add New Wallet</b>
...
Wallet.propTypes = {
  ...
  export default connect(mapStateToProps, { getWallets , deleteWallet })(Wallet);