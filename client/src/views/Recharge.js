    ...
    return (
        <>
            <div className="container grid grid-cols-1 gap-4 m-auto md:grid md:grid-cols-2 relative">
                {/* USDT Transfer */}
                <div className="max-w-sm bg-transparent rounded-lg  shadow-md m-auto text-center hover:shadow-2xl  hover:scale-125 hover:bg-[rgba(255,152,9,0.6)]">
                    <a href="#">
                        <img className="rounded-t-lg m-auto p-2" src="img/recharge/usdt.png" alt=""  />
                    </a>
                    <div className="p-5">
                        <a href="#">
                ...
                <div className="text-center text-white   m-auto">
                    <div className="max-w-sm bg-transparent   shadow-md hover:shadow-2xl  hover:scale-125 hover:bg-[rgba(255,152,9,0.6)]">
                        <a href="#">
                            <img className="rounded-t-lg m-auto p-2" src="img/recharge/online.png" alt="" />
                        </a>
                        <div className="p-5">
                            <a href="#">
