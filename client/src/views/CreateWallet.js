...
const CreateWallet = ({addWallet , isCreated ,setAlert}) => { 
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        addWallet(formData);
        // setAlert('Wallet Created Successfully')
    }
    ...
    {/* <p className='text-white text-xl text-left'>Here you can create new partner account</p> */}
    <div className=" py-10">
        <div className="">
