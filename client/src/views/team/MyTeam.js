                ...
                <div href="#" class="flex flex-col items-center  rounded-lg m-auto w-full border hover:shadow-2xl md:flex-row mt-5">
                    ...
                    <a class="flex flex-col justify-between p-4 leading-normal">
                        <div className='inline-flex items-baseline '>
                            ...
                            <p class="mb-2   tracking-tight text-white text-xl">{account.accountName}</p>
                        </div>
                        <div className='inline-flex items-baseline'> 
                        ...
                        <div className='inline-flex items-baseline'> 
                            ...
                            <p class="mb-3 font-normal text-white text-xl">{account.date}</p>
                        </div>
                        <div class="py-4 px-6 w-full">
                                    <button onClick={() => { deleteAccount(account._id) }} class="text-white p-2 bg-blue-500 hover:bg-blue-700 font-mono rounded rounded-tl-lg rounded-br-lg text-2xl"><Text tid={'delete'} /></button>
                        </div>  
                    </a> 
                </div>
            </div> : ''
