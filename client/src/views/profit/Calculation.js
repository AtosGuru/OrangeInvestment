...
const Calculation = ({ setAlert}) => {
    ...
    const onChange = (e) => {
        if (e.target.type == "number") {
            ...
            // console.log(e.target.getAttribute("percent"));
    ...
    return (
        <>
            <div className="p-5 relative m-auto">
                ...
                {/* <p className='text-white text-xl text-left'><Text  tid={"profit-calc-des"}/></p> */}
                <div className=" py-10">
                    <div className="">
                        <div className="max-w-[500px] w-5/6  text-white text-xl">
                            ...
                            <div className="grid grid-cols-3 gap-5  mt-5 p-2">
                                    <label className=""><Text  tid={"profit"}/>:  { Math.floor(profit) } $</label>
                            </div>
                            <div className="inline-flex p-2">
                                <label className=""><Text tid={"total"} /> : { Math.floor(total)} $</label>
                            </div>
                            <div className="p-2">
