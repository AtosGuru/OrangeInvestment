        ...
        <>
            <div className="container grid grid-cols-1 gap-4 m-auto md:grid md:grid-cols-2 relative p-4">
                ...
                <div className="max-w-sm shadow-2xl bg-transparent rounded-lg border border-gray-200  m-auto text-center ">
                    <a href="#">
                        <img className="rounded-t-lg m-auto p-2" src="img/profit/slide-new-1.png" alt=""  />
                    </a>
                    <div className="p-5">
                        <a href="#">
                ...
                {/* Online Payment   */}
                <div className="text-center text-white shadow-2xl  m-auto">
                    <div className="max-w-sm bg-transparent  border border-gray-200 shadow-md p-4">
                        <a href="#">
                            <img className="rounded-t-lg m-auto p-2" src="img/profit/slide-new-3.png" alt="" />
                        </a>
                        <div className="p-5">
                            <a href="#">
                            ...
                            <button href="#" className="inline-flex items-center py-2 px-3 text-base font-medium text-center text-white rounded-tl-2xl  rounded    hover:border hover:border-black    rounded-br-2xl    bg-transparent border border-white  ">
                                <Text tid={'more'}/>
